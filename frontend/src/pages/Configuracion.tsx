...
export const Configuracion = () => {
    ...
    function cargarAuditoria() {
        api.get('/auditoria', { pageSize: 5 }).then((data) => setAuditoriaReciente(data.registros)).catch(() => {});
    }
                        ...
                        <div className="bg-surface-container-lowest rounded-xl border border-outline-variant shadow-sm p-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                                ...
                                <div>
                                    ...
                                    <input className="w-full bg-surface border border-outline-variant rounded-lg px-4 py-2 font-data-mono text-data-mono text-on-surface" type="text" value={empresa.rnc} onChange={(e) => setEmpresa({ ...empresa, rnc: e.target.value })} />
                                </div>
                                <div>
                                    <label className="block font-label-caps text-label-caps text-on-surface-variant mb-1">Teléfono</label>
                                    <input className="w-full bg-surface border border-outline-variant rounded-lg px-4 py-2 font-body-md text-body-md text-on-surface" type="tel" value={empresa.telefono} onChange={(e) => setEmpresa({ ...empresa, telefono: e.target.value })} />
                                </div>
                                <div className="sm:col-span-2">
